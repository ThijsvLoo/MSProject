 ...
 *	@version %I%, %G%
 */
public class CorporateCSA implements CProcess,ProductAcceptor
{
	...
	*/
	public CorporateCSA(Queue q, ProductAcceptor s, CEventList e, String n, double m)
	{
		status='i';
		queue=q;
		sink=s;
	...
	*/
	public CorporateCSA(Queue q, ProductAcceptor s, CEventList e, String n, double[] st)
	{
		status='i';
		queue=q;
		sink=s;
